...
# Revised by J. Wallace Feb 2020; using fine_scale = TRUE in VAST ver. 3X and JRWToolBox::YearlyResultsFigure_VAST3X, but otherwise uses the mid-level functions approach
...
Spatial_List = FishStatsUtils::make_spatial_info(fine_scale = TRUE, grid_size_km = grid_size_km, n_x = n_x, Method = Method, Lon = Data_Geostat[,'Lon'], Lat = Data_Geostat[,'Lat'],
...
# JRWToolBox::YearlyResultsFigures(Graph.Dev = 'png', numCol = 100) # This function looks for 'spShortName' (defined above)

JRWToolBox::YearlyResultsFigure_VAST3X(Report. = Report, fit. = Opt, Graph.Dev = 'png') 
